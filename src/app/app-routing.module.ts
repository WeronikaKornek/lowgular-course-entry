...
const routes: Routes = [{ path: 'list', component: EmployeeListComponent }, { path: 'create-employee', component: EmployeeFormComponent }, { path: '', component: HomeComponent }, { path: 'employee-details/:id', component: EmployeeDetailsComponent }];
